...
OPTIONS = (
    ...
    Option(
        key="collections",
        question="Read your collections?",
    ...
    Option(
        key="access_requests",
        question="See access requests for your gated repos?",
    ...
    Option(
        ...
        question="See the org's service accounts?",
